...
<div class="card preset-filled-warning-100-900 p-4 mx-8 lg:mx-96 mt-8 text-center">
	<h3 class="h3">🏗️ Early Alpha: Under Construction 🏗️</h3>
	<p class="text-warning-900-100">
		This open source project is under construction in the very early alpha stages and is not yet
		ready for production. If you're interested please contact or reach out on GitHub or Discord.
	</p>
</div>
...
>
	<div class="py-12">
		...
		<div class="flex justify-center gap-2">
			<button
				type="button"
				class="btn preset-outlined-primary-900-100 mr-4 justify-center"
				onclick={redirectToProduct}>Learn More</button
			>
			<button type="button" class="btn preset-outlined-primary-900-100" onclick={redirectToDocs}
...
<div class="grid grid-cols-2 gap-4 lg:gap-16 p-4 lg:px-48">
	<div class="card preset-filled-surface-100-900 p-4">
		<div class="card-header"><h3 class="h3">Full Ownership & Privacy</h3></div>
	...
	<div class="card preset-filled-surface-100-900 p-4">
		<div class="card-header"><h3 class="h3">Data Pipeline & Storage</h3></div>
		<div class="card-footer">
			<p>
	...
	<div class="card preset-filled-surface-100-900 p-4">
		<div class="card-header"><h3 class="h3">Attribution Models</h3></div>
		<div class="card-footer">
			<p>
	...
	<div class="card preset-filled-surface-100-900 p-4">
		<div class="card-header"><h3 class="h3">Full MMP Analytics Dashboard</h3></div>
		<div class="card-footer">
			<p>
