				...
				<Form.Control>
					{#snippet children({ props })}
						...
						<p class="text-muted-foreground text-sm">
							Your app's public SHA256 fingerprint is used by Android to verify your apps deep
							links. The public key is generated by running:
							<code class="bg-muted p-1 rounded-md block my-2">
								keytool -list -v -keystore your-app-key.keystore
							</code>
							This command works for both <code class="bg-muted px-1 rounded-md">.keystore</code>
							and <code class="bg-muted px-1 rounded-md">.jks</code> files.
							<br /><br />
							Your SHA256 fingerprint should look like:
							<code class="bg-muted p-1 rounded-md block my-2">
								00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00
							</code>. You can read more about SHA256 fingerprints
							<a
